...
function App() {
  ...
  return (
    <>
      <Submission value={value} setValue={setValue} todo={todo} setToDo={setToDo} completeCounter={completeCounter}/>
      ...
      <button onClick = {() => {
        ...
        <Statebutton text='all tasks' bool={undefined} handleClick={handleClick} />
